(() => {
  ...
  !(function () {
    ...
    (e = function (e) {
      ...
      (document.getElementById("HBurger").onclick = function () {
        document.getElementById("HBurger").classList.toggle("active"),
          document.getElementById("HMenu").classList.toggle("active"),
          document.querySelector("body").classList.toggle("lock");
      });
    const i = document.querySelectorAll(".popup__link"),
    ...
    if (i.length > 0)
      for (let v = 0; v < i.length; v++) {
        ...
        y.addEventListener("click", function (e) {
          const t = y.getAttribute("href").replace("#", "");
          a(document.getElementById(t)), e.preventDefault();
        });
      }
    const o = document.querySelectorAll(".popup__close");
    if (o.length > 0)
      for (let E = 0; E < o.length; E++) {
        const L = o[E];
        L.addEventListener("click", function (e) {
          r(L.closest(".popup")), e.preventDefault();
        });
      }
    function a(e) {
      if (e && l) {
        ...
        t
          ...
          : (function () {
              const e =
                ...
                "px";
              if (n.length > 0)
                for (let t = 0; t < n.length; t++) n[t].style.paddingRight = e;
              (s.style.paddingRight = e),
      ...
      l &&
        ...
        t &&
          (setTimeout(function () {
            ...
            (s.style.paddingRight = "0px"), s.classList.remove("lock");
          }, 800),
          (l = !1),
          setTimeout(function () {
            l = !0;
    ...
    document.addEventListener("keydown", function (e) {
      27 === e.which && r(document.querySelector(".popup.open"));
    });
    let h = document.getElementById("map_container"),
      c = { once: !0, passive: !0, capture: !0 };
    if (h) {
      h.addEventListener("click", A, c),
        h.addEventListener("mouseover", A, c),
        h.addEventListener("touchstart", A, c),
        h.addEventListener("touchmove", A, c);
      let b = !1;
      function A() {
        if (!b) {
          ...
          (b = !0),
            ...
            (document.querySelector("#mapImg").style.display = "none"),
    ...
    const d = document.getElementsByClassName("accordion");
    let g;
    if (document.getElementsByClassName("accordion"))
      for (g = 0; g < d.length; g++)
        d[g].addEventListener("click", function () {
          ...
          if (e.style.maxHeight)
            ...
            let t = document.querySelectorAll(".accordion.active");
            for (let e = 0; e < t.length; e++)
              t[e].classList.remove("active"),
                t[e].setAttribute("aria-expanded", "false"),
                (t[e].nextElementSibling.style.maxHeight = null),
                t[e].nextElementSibling.classList.remove("open");
    ...
    if (
      ...
      document.querySelector(".media__container"))
    ) {
      let S = document.getElementsByTagName("img");
      for (let w = 0; w < S.length; w++)
        S[w].addEventListener("click", function () {
          document.querySelector(".popup-img").src = S[w].src;
        });
    }
    const m = document.querySelectorAll("img[data-src],source[data-srcset]"),
      u = document.documentElement.clientHeight;
    let p = [];
    function f() {
      let e = p.findIndex((e) => pageYOffset > e - u);
      e >= 0 &&
        (m[e].dataset.src &&
          ((m[e].src = m[e].dataset.src), m[e].removeAttribute("data-src")),
        delete p[e]);
    }
    m.length > 0 &&
      m.forEach((e) => {
        (e.dataset.src || e.dataset.srcset) &&
          (p.push(e.getBoundingClientRect().top + pageYOffset), f());
      }),
    ...
    (function () {
      class e {
        ...
        onDeviceOrientation(e) {
          ...
          null !== this.updateCall && cancelAnimationFrame(this.updateCall),
            (this.event = { clientX: l + this.left, clientY: o + this.top }),
...
// Получаем параметры и отображаем приветственное сообщение
const params = getQueryParams();
if (params.first_name) {
    document.getElementById('welcomeMessage').innerText = "Добро пожаловать, " + params.first_name + "!";
}